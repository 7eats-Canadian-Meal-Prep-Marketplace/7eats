      ...
      <section className="section values">
        <div className="wrap">
          <div className="values-head">
            ...
            <h2 className="h-xl" style={{ marginTop: 18 }}>
              <Image src="/7eats-icon-red.svg" alt="7eats" width={48} height={48} style={{ display: "inline-block", verticalAlign: "top", marginRight: 12, marginTop: -4 }} /> rules we don&apos;t break.
            </h2>
          </div>
